...
/*
this.state.total_deaths[0] = this.state.data.features[this.state.data.features.length-(1+0)].attributes.TotalCovidDeaths;
this.state.total_deaths[1] = this.state.data.features[this.state.data.features.length-(1+1)].attributes.TotalCovidDeaths;
this.state.total_deaths[2] = this.state.data.features[this.state.data.features.length-(1+2)].attributes.TotalCovidDeaths;
this.state.total_deaths[3] = this.state.data.features[this.state.data.features.length-(1+3)].attributes.TotalCovidDeaths;
this.state.total_deaths[4] = this.state.data.features[this.state.data.features.length-(1+4)].attributes.TotalCovidDeaths;
this.state.total_deaths[5] = this.state.data.features[this.state.data.features.length-(1+5)].attributes.TotalCovidDeaths;
this.state.total_deaths[6] = this.state.data.features[this.state.data.features.length-(1+6)].attributes.TotalCovidDeaths;

this.state.total_cases[0]  = this.state.data.features[this.state.data.features.length-(1+0)].attributes.TotalConfirmedCovidCases;
this.state.total_cases[1]  = this.state.data.features[this.state.data.features.length-(1+1)].attributes.TotalConfirmedCovidCases;
this.state.total_cases[2]  = this.state.data.features[this.state.data.features.length-(1+2)].attributes.TotalConfirmedCovidCases;
this.state.total_cases[3]  = this.state.data.features[this.state.data.features.length-(1+3)].attributes.TotalConfirmedCovidCases;
this.state.total_cases[4]  = this.state.data.features[this.state.data.features.length-(1+4)].attributes.TotalConfirmedCovidCases;
this.state.total_cases[5]  = this.state.data.features[this.state.data.features.length-(1+5)].attributes.TotalConfirmedCovidCases;
this.state.total_cases[6]  = this.state.data.features[this.state.data.features.length-(1+6)].attributes.TotalConfirmedCovidCases;
